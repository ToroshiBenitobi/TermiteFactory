...
public class SchedulingRankingAndCrowdingDistanceComparator<S extends Solution<?>>
    ...
    public SchedulingRankingAndCrowdingDistanceComparator(Ranking<S> ranking) {
    ...
    public SchedulingRankingAndCrowdingDistanceComparator() {
